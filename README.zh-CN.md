...
| `standard` | 6.0% | 4.5% | 78% | 默认口播与演示视频 |
| `emphasis` | 7.2% | 5.2% | 80% | 字少、强调感强的字幕 |

`standard` 在 1080 高画面中约为 65 px，在 2160 高画面中约为 130 px。单条字幕过长时，排版器会在预设下限内缩小；仍无法放进两行时会要求拆句，不会裁掉文字。
