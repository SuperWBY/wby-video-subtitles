...
| `standard` | 6.0% | 4.5% | 78% | 標準のトーク・デモ動画 |
| `emphasis` | 7.2% | 5.2% | 80% | 短く強調したい字幕 |

`standard` は高さ 1080 の動画で約 65 px、高さ 2160 で約 130 px から始まります。長い字幕はプリセットの最小値まで縮小され、それでも二行に収まらない場合は分割と再タイミングを求めます。
